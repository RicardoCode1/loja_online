...
<body>
    ...
    <!-- Navbar -->
    <?php
 View::componente('nav/nav', ['categorias' => $categorias,]);
 ?>
    <!-- Banner principal -->
    ...
    <main>
        <!-- Benefícios -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_benef.php'; ?>

        <!-- Categorias -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_categ.php'; ?>

        <!-- Produtos em destaque -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_dest.php'; ?>

        <!-- Oferta -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_ofer.php'; ?>

        <!-- Mais vendidos -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_maisv.php'; ?>

        <!-- Newsletter -->
        <?php require_once APP_ROOT . '/views/componentes/site/sections/sec_news.php'; ?>
    </main>
